...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\Huge\bfseries Creating Mathematical Animations with Manim\par} % Book title
		\vspace{16pt} % Vertical whitespace
		{\LARGE A Cookbook for Everyone\par} % Subtitle
		\vspace{24pt} % Vertical whitespace
		{\huge\bfseries Ralph Göstenmeier\par} % Author name
	}
...
\noindent Copyright \copyright\ 2022 Ralph Göstenmeier\\
\noindent \textsc{Published by Publisher}\\
% \noindent \textsc{\href{{https://programmier-workshops.de}{https://programmier-workshops.de/}}\\
...
\chapter{Section 3}\index{Sectioning}

\section{Section3 Title}\index{Sectioning!Sections}
